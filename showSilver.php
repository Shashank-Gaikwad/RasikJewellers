 ...
 //$con=mysqli_connect('localhost','root','','rasik_jewellers') or die(mysqli_connect_error());
	...
	if($str==1)
		$productQuery="select * from masterdata where remark1='new' and productMaterial='Silver'";
	if($str==2)
		$productQuery="select * from masterdata where remark2='marriage' and productMaterial='Silver'";
	if($str==3)
		$productQuery="select * from masterdata where remark3='trend' and productMaterial='Silver'";
